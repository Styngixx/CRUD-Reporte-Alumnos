  ...
  private void cargarCiclosParaLista(){
   ...
   private void actualizarGrafico(DefaultPieDataset dset, String tittle){
    ...
    private void initComponents() {
        ...
        bg.add(boogie, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 780, 580));

        jLabel1.setText("Selecciona un semestre:");
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 130, 150, -1));

        jScrollPane1.setViewportView(List);

        bg.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 160, 130, 290));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(bg, javax.swing.GroupLayout.DEFAULT_SIZE, 954, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GraphicStudentSemester().setVisible(true);
            }
        });
    }
