...
private void cargarCursos(){ // Adaptado de cargarProductos()
    ...
    private void initComponents() {
        ...
        bg.add(boogie, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 840, 630));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel1.setText("Selecciona un curso:");
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 110, 150, -1));

        jScrollPane1.setViewportView(List);

        bg.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 140, 140, 350));
